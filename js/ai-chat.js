        ...
        <div class="ai-chat-box" id="aiChatBox">
            ...
            <div class="ai-chat-messages" id="aiMessages">
                <div class="ai-message ai-bot">
                    <p>Halo! 👋 Saya asisten AI MarendalSatu. Ada yang bisa saya bantu?</p>
                </div>
            </div>
    ...
    try {
        const response = await fetch(AI_CONFIG.apiUrl, {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { role: 'system', content: 'Kamu asisten AI MarendalSatu. Jawab singkat, jelas, tanpa emoji berlebihan, tanpa bullet point, tanpa format markdown. Pakai bahasa Indonesia santai seperti ngobrol biasa. Langsung ke inti jawaban.' },
                    ...chatHistory.slice(-6),
